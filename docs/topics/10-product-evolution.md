...
- 全枝を横断した提出案の最終決定
- talk11枝内でも残る Living Decisions / 誤概念診断 / Executable Falsifier の選択
- Meeting State Model v0.2 と Living Decision state machine の統合
- Work & Productivity / Education / Developer Tools の最終部門
...
- talk11枝の暫定製品候補: [12-counterpoint-living-decisions.md](./12-counterpoint-living-decisions.md)
