...
| `03-ip-and-license` | [02](./02-identity-permissions-and-security.md), [user decisions](../decisions/user-decisions.md) | [06](../plans/06-quality-deployment-and-submission.md) | Public-at-submission decision recorded; final license follows dependency and submission audit |
