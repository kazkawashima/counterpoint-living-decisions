...
| AC-18 | Partial      | Worker/unit/Cloudflare tests plus a production browser context reject synthetic `safety` with `403 JUDGE_MODE_FORBIDDEN` before managed work; browser controls remain absent                                                                                                                                                      | Hosted C5 response/log scan                                                     |
